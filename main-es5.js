...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(q, router) {
        this.q = q;
        this.router = router;
    ...
    LoginComponent.prototype.login = function (ls) {
        var _this = this;
        this.q.post(this.baseUrl + '/login', ls.value).subscribe(function (res) {
            console.log(res);
...
var NaviagtionComponent = /** @class */ (function () {
    function NaviagtionComponent(authService) {
        this.authService = authService;
    }
    NaviagtionComponent.prototype.ngOnInit = function () {
    };
    NaviagtionComponent.ctorParameters = function () { return [
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(q, router) {
        this.q = q;
        this.router = router;
        this.baseUrl = "http://localhost:3001";
    }
    ...
    RegisterComponent.prototype.sendData = function (us) {
        var _this = this;
        this.q.post(this.baseUrl + '/useradd', us.value).subscribe(function (res) {
            console.log(res);
            localStorage.setItem('token', res['token']);
            _this.router.navigate(['/special']);
        }, function (err) { return console.log(err); });
